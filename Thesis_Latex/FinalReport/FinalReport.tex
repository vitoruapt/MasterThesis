...
\usepackage{pdfpages}
\begin{document}
\includepdf[page=-]{./coverpage/coverpage.pdf}
\maketitle
\thispagestyle{plain}
\pagestyle{plain}
\begin{abstract}
...
The proposed algorithms were studied for the ATLASCAR project in which the group for Robotics and Automation at the University of Aveiro has setup and adapted a common commercial vehicle to provide a versatile  framework  to  develop  studies  and  research %\cite{atlas}
...
\begin{figure}[h!]
	...
	\includegraphics[width=\columnwidth]{./figure/one_obstacle_right_overtaking/overtaking_start.pdf}
	\end{minipage}
	\begin{minipage}[t]{\columnwidth}
	\includegraphics[width=\columnwidth]{./figure/one_obstacle_right_overtaking/overtaking_middle.pdf}
	\end{minipage}
	\begin{minipage}[t]{\columnwidth}
	\includegraphics[width=\columnwidth]{./figure/one_obstacle_right_overtaking/overtaking_middle_end.pdf}
	\end{minipage}
	\begin{minipage}[t]{\columnwidth}
	\includegraphics[width=\columnwidth]{./figure/one_obstacle_right_overtaking/overtaking_end.pdf}
	\end{minipage}
...
\begin{figure*}[!t] %vs changes to t instead of b
	\begin{minipage}[t]{\columnwidth}
		\includegraphics[width=\columnwidth]{./figure/three_obstacles_no_overtaking/VelocityVsTime.pdf}
		\vspace{-17pt}
		\subcaption{}\label{fig:velocity_braking}
	\end{minipage}
	\begin{minipage}[t]{\columnwidth}
		\includegraphics[width=\columnwidth]{./figure/three_obstacles_no_overtaking/ThrottleVsTime.pdf}
		\vspace{-17pt}
		\subcaption{}\label{fig:throttle_braking}
	\end{minipage}
	\begin{minipage}[t]{\columnwidth}
	    \includegraphics[width=\columnwidth]{./figure/three_obstacles_no_overtaking/SteeringAngleVsTime.pdf}
	    \vspace{-17pt}
	    \subcaption{}\label{fig:delta_braking}
	\end{minipage}
	\begin{minipage}[t]{\columnwidth}
	    \includegraphics[width=\columnwidth]{./figure/three_obstacles_no_overtaking/HeadingAngleVsTime.pdf}
	    \vspace{-17pt}
...
\end{minipage}
\begin{minipage}[t]{\columnwidth}
	\includegraphics[width=\columnwidth]{../../MATLAB/lane_following/figure/AccelerationVsTime.pdf}
...
\begin{thebibliography}{00}
	...
	\bibitem{borelli3}Monimoy Bujarbaruah, Xiaojing Zhang, H. Eric Tseng, Francesco Borrelli; Adaptive MPC for Autonomous Lane Keeping, 14th International Symposium on Advanced Vehicle Control (AVEC), Beijing, China, July 2018
%	\bibitem{atlas}ATLAS  Project,  Aveiro  University, Portugal, \url{http://atlas.web.ua.pt/}, last visited July 2010.
	...
	\bibitem{longitudinal}Filip, Jan. (2018). Trajectory Tracking for Autonomous Vehicles.
	
	\bibitem{curvature}Danwei Wang, Feng Qi, "Trajectory planning for a four-wheel-steering vehicle," 2001 International Conference on Robotics and Automation, Seoul, Korea, 2001
	
	\bibitem{error_model}H. Yang, M. Guo, Y. Xia and L. Cheng, "Trajectory tracking for wheeled mobile robots via model predictive control with softening constraints," in IET Control Theory \& Applications, vol. 12, no. 2, pp. 206-214, 30 1 2018.
\end{thebibliography}
