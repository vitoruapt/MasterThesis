...
print(h1,'figure\SteeringAngleVsTime_circular','-dpdf','-r0')
hold off
pause(2)
...
print(h2,'figure\LateralDeviationVsTime_circular','-dpdf','-r0')
hold off
pause(2)
...
print(h3,'figure\RelativeYawAngleVsTime_circular','-dpdf','-r0')
hold off
pause(2)
...
print(h4,'figure\AccelerationVsTime_circular','-dpdf','-r0')
hold off
pause(2)
...
print(h5,'figure\LongitudinalVelocityVsTime_circular','-dpdf','-r0')
hold off
pause(2)
...
print(h6,'figure\LateralVelocityVsTime_circular','-dpdf','-r0')
hold off
pause(2)
